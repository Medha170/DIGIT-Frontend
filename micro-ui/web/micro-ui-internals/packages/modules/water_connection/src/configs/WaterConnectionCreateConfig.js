...
export const config = [
  {
    head: "WaterConnection Object Creation",
    ...
    body: [
      ...
      },
      {
        ...
        populators: {
          name: "gender",
          optionsKey: "name",
          error: "water_connection required message",
          required: true,
          mdmsConfig: {
      ...
      },
      {
        ...
        type: "number",
        disable: false,
        populators: { name: "age", error: "water_connection error message", validation: { min: 0, max: 100 } },
      },
      {
        inline: true,
        label: "DOB",
      ...
      },
      {
        ...
        type: "mobileNumber",
        disable: false,
        populators: { name: "phNumber", error: "water_connection error message", validation: { min: 5999999999, max: 9999999999 } },
      },
    ...
    body: [
      {
        ...
        type: "text",
        disable: false,
        populators: { name: "additionalDetails", error: "water_connection error message", validation: { pattern: /^[A-Za-z]+$/i } },
      },
      ...
      // {
      //   "type": "component",
      //   "component": "WaterConnectionComponent",
      //   "withoutLabel": true,
      //   "key": "comments"
      // },
    ],
